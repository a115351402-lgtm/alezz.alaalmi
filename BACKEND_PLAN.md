...
> **✅ اكتملت جميع المراحل (0–6) ودُمجت في `main` بتاريخ 2026-07-16.**
> المرجع التشغيلي: `supabase/README.md` (المفاتيح وسير الترحيلات) و`supabase/TESTING.md` (مصفوفة الاختبار).
